...
class DreameMowerMiHomeCloudProtocol:
    def __init__(self, username: str, password: str, country: str) -> None:
        ...
        self._did = None
        self.two_factor_url = None
        self._useragent = f"Android-7.1.1-1.0.0-ONEPLUS A3010-136-{DreameMowerMiHomeCloudProtocol.get_random_agent_id()} APP/Mova_Smarthomee APPV/62830"
    ...
    def get_dreame_iot_api_url(self) -> str:
        return f"https://{('' if self._country == 'cn' else (self._country + '.'))}iot.mova-tech.com:13267/dreame-iot-com-20000"
